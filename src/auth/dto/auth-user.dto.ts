...
export class AuthUserDto {
  ...
  static fromEntity(authUser: AuthUser): AuthUserDto {
    ...
    dto.displayName = authUser.displayName;
    dto.bio = authUser.bio;
    dto.avatarUrl = authUser.avatarUrl;
    dto.location = authUser.location;
    dto.website = authUser.website;
    dto.socialLinks = authUser.socialLinks;
    dto.skills = authUser.skills;
